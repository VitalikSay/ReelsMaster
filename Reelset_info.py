class SymbolData():  # Надо чтобы этот класс был дочерним к классу Reel
    def __init__(self, game_name="test_game", section_name="test_section", short_info="test_info"):
        ...
        #!!! Надо чтобы пo оимени создавалась папка в Data !!!
